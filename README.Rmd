...
Assists USACE engineers in making hydraulic calculations required to design a chute. [Check it out!](https://fluvialgeomorph-chutedesign.share.connect.posit.cloud/)
...
## Bug Reports
If you find any bugs using `chutedesign`, please open an [issue](https://github.com/FluvialGeomorph/chutedesign/issues). 
