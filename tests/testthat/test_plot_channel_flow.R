test_that("check by_width_df plots", {
  ...
  x_axis <- "width"
  plot1 <- plot_channel_flow(channel_dims, x_axis)
  #plot1
  expect_s3_class(plot1, "ggplot")
})

test_that("check by_length_df plots", {
  scenario <- create_scenario (
    width               = 60,
    width_start         = 40,
    width_end           = 200,
...
test_that("check by_slope_df plots", {
  ...
  channel_dims <- channel_dimensions(channel_df)
  x_axis <- "slope"
  plot2 <- plot_channel_flow(channel_dims, x_axis)
  #plot2
...
test_that("check by_particle_size_df plots", {
  ...
  plot3 <- plot_channel_flow(channel_dims, x_axis)
  #plot3
